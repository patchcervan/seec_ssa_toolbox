...
# Load covariates
elev <- aggregate(raster("data/res01_srtm0_40_16.tif"), fact = 10)
slp <- aggregate(raster("data/res01_slope_40_16.tif"), fact = 10)
...
# Extract covariates
elev <- aggregate(raster("data/res01_srtm0_40_16.tif"),
                  fact = 10)
slp <- aggregate(raster("data/res01_slope_40_16.tif"),
                 fact = 10)
